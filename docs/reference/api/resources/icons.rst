...
The filename specified for an icon can be specified as an absolute path, or as a path
relative to the module that defines your Toga application. It should be specified
*without* an extension; the platform will determine an appropriate extension, and may
also modify the name of the icon to include a file size qualifier.
...
An icon is **guaranteed** to have an implementation. If you specify a path and not
