...
- It is now possible to draw bitmap images on a `Canvas`. ([#995](https://github.com/beeware/toga/issues/995))
- The `DetailedList` widget on Windows has been massively improved, and now matches the visual appearance on other platforms. ([#2110](https://github.com/beeware/toga/issues/2110), [#4319](https://github.com/beeware/toga/issues/4319))
- Widget implementations are now contributed by entry points, allowing lazy loading on a per-widget basis. ([#2687](https://github.com/beeware/toga/issues/2687))
- Toga's WinForms backend can now be used on ARM64 machines with a native ARM64 Python interpreter. ([#2782](https://github.com/beeware/toga/issues/2782))
- The GTK4 backend now integrates with libadwaita for ActivityIndicator, Window, and App. ([#3069](https://github.com/beeware/toga/issues/3069))
- Toga Positron now has a bootstrap for FastAPI-based websites. ([#3327](https://github.com/beeware/toga/issues/3327))
- The `WebView` widget now supports an on_navigation_starting handler to prevent user-defined URLs from being loaded ([#3442](https://github.com/beeware/toga/issues/3442))
- The Qt backend now has implementations for all widgets, plus support for dialogs, fonts and status icons. ([#3914](https://github.com/beeware/toga/issues/3914))
- The currently active backend can now be retrieved at runtime using `toga.backend`. ([#3923](https://github.com/beeware/toga/issues/3923))
- Android apps now support the use of `webbrowser.open()`. ([#3932](https://github.com/beeware/toga/issues/3932))
- The `on_webview_load` handler is now supported on Android ([#4036](https://github.com/beeware/toga/issues/4036))
- Apps built with Toga no longer requires the "Requires Full Screen" key in the app template, allowing support for multitasking on iPadOS. ([#4043](https://github.com/beeware/toga/issues/4043))
- The columns of `Table` and `Tree` widgets can now be specified using `Column` objects that provide a richer interface for configuring data access. ([#4091](https://github.com/beeware/toga/issues/4091))
- The header row of a `Table` and `Tree` widget can now be hidden. ([#4091](https://github.com/beeware/toga/issues/4091))
- The `rgb` and `hsl` color representation classes now declare slots, reducing memory usage. ([#4136](https://github.com/beeware/toga/issues/4136))
- The `Canvas` widget can now draw rounded rectangles. ([#4161](https://github.com/beeware/toga/issues/4161))
- The Table widget on WinForms can now display icons in all columns. Previously, icons were only supported in the first column. ([#4164](https://github.com/beeware/toga/issues/4164))
- `ListSource` and `TreeSource` now allow mapping-based data to be used without explicitly providing accessors. ([#4221](https://github.com/beeware/toga/issues/4221))
- The web backend now uses WebAwesome instead of Shoelace to provide web components. ([#4227](https://github.com/beeware/toga/issues/4227))
- The `Switch` widget is now supported in the Textual backend. ([#4230](https://github.com/beeware/toga/issues/4230))
- The `Tree` widget is now supported in the Windows backend. ([#4235](https://github.com/beeware/toga/issues/4235), [#4360](https://github.com/beeware/toga/issues/4360))
- macOS and iOS apps can now use any font that has been registered with the operating system. ([#4307](https://github.com/beeware/toga/issues/4307))
- The `Canvas` widget now has `save` and `restore` methods, and supports setting the drawing context attributes `fill_style`, `stroke_style`, `line_width`, and `line_dash`. ([#4332](https://github.com/beeware/toga/issues/4332))
- The Toga repository now has an `AGENTS.md` file and [Spec Kit](https://github.github.com/spec-kit/) constitution to provide assistance for Generative AI tools. ([#4344](https://github.com/beeware/toga/issues/4344))

### Bugfixes

- The `Canvas` widget on Android, Qt and WinForms now matches the behavior of the HTML Canvas when a transform is applied while preparing a path. ([#2206](https://github.com/beeware/toga/issues/2206))
- Calling `stroke()` or `fill()` in a `Canvas` context no longer clears the current path. ([#2207](https://github.com/beeware/toga/issues/2207))
- `SplitContainers` in a non-primary tab of `OptionContainer` will now correctly apply its split on Cocoa. ([#2288](https://github.com/beeware/toga/issues/2288))
- The key event handling code now supports non-US keyboards better on macOS. More keys are supported on Qt. ([#2428](https://github.com/beeware/toga/issues/2428))
- Memory leaks for all remaining widgets have been resolved on all leaking platforms. ([#2849](https://github.com/beeware/toga/issues/2849))
...
- Nested `OptionContainers` will now show label text correctly on iOS 26+. ([#3949](https://github.com/beeware/toga/issues/3949))
- On iOS, the height of the top status bar will now be accounted for properly when the device is rotated. ([#3957](https://github.com/beeware/toga/issues/3957))
- Apps now log an error instead of crashing if the system locale value is set to an unknown or invalid value. ([#3984](https://github.com/beeware/toga/issues/3984))
- `Label`, `Box`, and `ImageView` widgets will now display with a transparent background on the Qt backend. ([#3997](https://github.com/beeware/toga/issues/3997))
- `NumberInput` values on macOS no longer visually disappear when the widget loses focus. ([#3998](https://github.com/beeware/toga/issues/3998))
- Cocoa and GTK `OptionContainer` widgets now rehints properly to accommodate for all of its content sizes at all times, in addition to the decorations around them. ([#4010](https://github.com/beeware/toga/issues/4010))
- `OptionContainer` and `ScrollContainer` widgets inside an `OptionContainer` will no longer error on layout on Cocoa. ([#4010](https://github.com/beeware/toga/issues/4010))
- Setting an item in a `ListSource` now gives a "change" instead of an "insert" notification. ([#4029](https://github.com/beeware/toga/issues/4029))
- Data source listeners are now fully disconnected when data changes in `DetailedList`, `Selection`, `Table` and `Tree` widgets. ([#4030](https://github.com/beeware/toga/issues/4030))
- On Cocoa, ineffective scrolls in an inner `ScrollContainer` will now be automatically passed on to the outer `ScrollContainer`. ([#4034](https://github.com/beeware/toga/issues/4034))
- Cocoa `ScrollContainer` widgets will now handle elastic effects in small contents properly in a fashion similar to native apps. ([#4034](https://github.com/beeware/toga/issues/4034))
- There are now different `Listener` protocols for `ValueSource`, `ListSource`, and `TreeSource`. ([#4035](https://github.com/beeware/toga/issues/4035))
- Any `AttributeError` generated by data source `Row` and `Node` objects now reference the correct attribute name. ([#4037](https://github.com/beeware/toga/issues/4037))
- GTK4's `DateInput` now consistently emits signals on programmatic change, even when only the year component is altered. ([#4040](https://github.com/beeware/toga/issues/4040))
...
- File reference handling in the Android event loop has been corrected. ([#4083](https://github.com/beeware/toga/issues/4083))
- On Cocoa, when not setting a background color, `DateInput`, `TimeInput`, and `MultilineTextInput` now paints the proper background. ([#4099](https://github.com/beeware/toga/issues/4099))
- On Cocoa, setting the background color from non-transparent colors to transparent now works correctly on the `Selection` and `MultilineTextInput` widgets. ([#4099](https://github.com/beeware/toga/issues/4099))
- Previously, it was documented that setting the colors for `Selection` would not work on Cocoa; however, the background color worked partially, coloring an entire rectangular widget instead of the widget itself. The color handling is now entirely removed for `Selection`. ([#4099](https://github.com/beeware/toga/issues/4099))
- There are no longer any zero division errors when drawing an ellipse in a `Canvas` on macOS, iOS or GTK backends. ([#4161](https://github.com/beeware/toga/issues/4161))
- The Android implementation of `Canvas` now has the same default corner-mitering threshold as the HTML canvas specification. ([#4162](https://github.com/beeware/toga/issues/4162))
- The mouse wheel scrolling behavior of `MultilineTextInput` has been improved. ([#4222](https://github.com/beeware/toga/issues/4222))
- Entering presentation mode with multiple windows now correctly puts all windows into presentation mode, not just the last one. ([#4233](https://github.com/beeware/toga/issues/4233))
- In Light Mode on macOS, when a `DetailedList` is not focused but has a selection, the text now draws dark instead of light to preserve contrast. ([#4264](https://github.com/beeware/toga/issues/4264))
- To better match native styling, the focus border on macOS `DetailedList` has been removed. ([#4270](https://github.com/beeware/toga/issues/4270))
- Right-aligned, multi-line strings that contain an empty line are now correctly sized on macOS. ([#4315](https://github.com/beeware/toga/issues/4315))
- `Canvas` now consistently handles line-dash patterns of an odd or zero length. ([#4334](https://github.com/beeware/toga/issues/4334))
- App-level dialogs on macOS 26 are now reliably responsive to clicks for dismissal. ([#4346](https://github.com/beeware/toga/issues/4346))
- Some runtime errors caused by Window event handlers firing as part of the window initialization process have now been silenced. ([#4347](https://github.com/beeware/toga/issues/4347))
- Toga's lazy-loading mechanism now uses an explicit file encoding. ([#4365](https://github.com/beeware/toga/issues/4365))
...
- Using `headings` as a keyword argument when creating `Table` and `Tree` objects is deprecated. Any `headings` argument should be replaced with `columns`. The use of `headings=None` to hide the header row has been deprecated; use `show_headings=False` instead. ([#4091](https://github.com/beeware/toga/issues/4091))
- Specifying `accessors` when creating `Table` and `Tree` widgets is deprecated. Use of `accessor` arguments on `insert_column()` and `append_column()` methods has also been deprecated. Use `accessor` arguments on column objects or data sources instead. ([#4091](https://github.com/beeware/toga/issues/4091))
- The behavior of the `Canvas` widget when a drawing was scaled by a factor of 0 in either axis was unspecified and varied across backends and HTML Canvas implementations. The `Canvas` widget now follows a consistent, reasonable behavior when this happens which should produce similar results on all backends. On some backends, to avoid errors or other drawing problems, a very small scale factor is used instead of 0 when asked to scale by 0. ([#4110](https://github.com/beeware/toga/issues/4110))
- The specification for `Tree`/`Table` column data has historically documented that an icon in a column is specified with a 2-tuple. However, on some platforms, the implementation has allowed n-tuples and/or other collection types. This has now been constrained - a 2-tuple is the *only* way to specify an icon for column data; and using a tuple of any length other than 2 will raise an error. ([#4135](https://github.com/beeware/toga/issues/4135))

### Documentation

- Documentation has been added for colors. ([#3568](https://github.com/beeware/toga/issues/3568))
- The "Success Stories" page has been reformatted into a structured table with consistent fields for platform support, screenshots, descriptions, and BeeWare components. ([#3596](https://github.com/beeware/toga/issues/3596))
- The API reference documentation has been restructured. ([#3941](https://github.com/beeware/toga/issues/3941))
- A new contribution guide has been added. ([#3969](https://github.com/beeware/toga/issues/3969))
- Data source topic guide now includes a discussion of how and when to connect and disconnect Listeners from Sources. ([#4030](https://github.com/beeware/toga/issues/4030))
- The API design guide now references the BeeWare code style guide. ([#4231](https://github.com/beeware/toga/issues/4231))
- The FAQ has been updated with entries about file access. ([#4239](https://github.com/beeware/toga/issues/4239))
- Known limitations on the usage of `OptionContainer` as nested content on mobile platforms are now documented. ([#4297](https://github.com/beeware/toga/issues/4297))
- The `Canvas` documentation has been revamped, with the existing content splitting into two pages (general reference and advanced usage), plus the addition of a migration guide for the new API changes. ([#4362](https://github.com/beeware/toga/issues/4362))

### Misc

- [#3685](https://github.com/beeware/toga/issues/3685), [#3819](https://github.com/beeware/toga/issues/3819), [#3861](https://github.com/beeware/toga/issues/3861), [#3923](https://github.com/beeware/toga/issues/3923), [#3928](https://github.com/beeware/toga/issues/3928), [#3942](https://github.com/beeware/toga/issues/3942), [#3944](https://github.com/beeware/toga/issues/3944), [#3945](https://github.com/beeware/toga/issues/3945), [#3948](https://github.com/beeware/toga/issues/3948), [#3951](https://github.com/beeware/toga/issues/3951), [#3952](https://github.com/beeware/toga/issues/3952), [#3953](https://github.com/beeware/toga/issues/3953), [#3954](https://github.com/beeware/toga/issues/3954), [#3955](https://github.com/beeware/toga/issues/3955), [#3963](https://github.com/beeware/toga/issues/3963), [#3967](https://github.com/beeware/toga/issues/3967), [#3968](https://github.com/beeware/toga/issues/3968), [#3975](https://github.com/beeware/toga/issues/3975), [#3977](https://github.com/beeware/toga/issues/3977), [#3978](https://github.com/beeware/toga/issues/3978), [#3979](https://github.com/beeware/toga/issues/3979), [#3980](https://github.com/beeware/toga/issues/3980), [#3981](https://github.com/beeware/toga/issues/3981), [#3982](https://github.com/beeware/toga/issues/3982), [#3983](https://github.com/beeware/toga/issues/3983), [#3988](https://github.com/beeware/toga/issues/3988), [#3991](https://github.com/beeware/toga/issues/3991), [#3993](https://github.com/beeware/toga/issues/3993), [#4000](https://github.com/beeware/toga/issues/4000), [#4001](https://github.com/beeware/toga/issues/4001), [#4002](https://github.com/beeware/toga/issues/4002), [#4003](https://github.com/beeware/toga/issues/4003), [#4005](https://github.com/beeware/toga/issues/4005), [#4019](https://github.com/beeware/toga/issues/4019), [#4023](https://github.com/beeware/toga/issues/4023), [#4024](https://github.com/beeware/toga/issues/4024), [#4025](https://github.com/beeware/toga/issues/4025), [#4033](https://github.com/beeware/toga/issues/4033), [#4041](https://github.com/beeware/toga/issues/4041), [#4046](https://github.com/beeware/toga/issues/4046), [#4050](https://github.com/beeware/toga/issues/4050), [#4052](https://github.com/beeware/toga/issues/4052), [#4055](https://github.com/beeware/toga/issues/4055), [#4056](https://github.com/beeware/toga/issues/4056), [#4057](https://github.com/beeware/toga/issues/4057), [#4058](https://github.com/beeware/toga/issues/4058), [#4068](https://github.com/beeware/toga/issues/4068), [#4075](https://github.com/beeware/toga/issues/4075), [#4085](https://github.com/beeware/toga/issues/4085), [#4086](https://github.com/beeware/toga/issues/4086), [#4094](https://github.com/beeware/toga/issues/4094), [#4095](https://github.com/beeware/toga/issues/4095), [#4096](https://github.com/beeware/toga/issues/4096), [#4097](https://github.com/beeware/toga/issues/4097), [#4100](https://github.com/beeware/toga/issues/4100), [#4103](https://github.com/beeware/toga/issues/4103), [#4104](https://github.com/beeware/toga/issues/4104), [#4105](https://github.com/beeware/toga/issues/4105), [#4108](https://github.com/beeware/toga/issues/4108), [#4109](https://github.com/beeware/toga/issues/4109), [#4115](https://github.com/beeware/toga/issues/4115), [#4116](https://github.com/beeware/toga/issues/4116), [#4117](https://github.com/beeware/toga/issues/4117), [#4118](https://github.com/beeware/toga/issues/4118), [#4119](https://github.com/beeware/toga/issues/4119), [#4120](https://github.com/beeware/toga/issues/4120), [#4121](https://github.com/beeware/toga/issues/4121), [#4122](https://github.com/beeware/toga/issues/4122), [#4123](https://github.com/beeware/toga/issues/4123), [#4124](https://github.com/beeware/toga/issues/4124), [#4125](https://github.com/beeware/toga/issues/4125), [#4126](https://github.com/beeware/toga/issues/4126), [#4127](https://github.com/beeware/toga/issues/4127), [#4128](https://github.com/beeware/toga/issues/4128), [#4129](https://github.com/beeware/toga/issues/4129), [#4130](https://github.com/beeware/toga/issues/4130), [#4131](https://github.com/beeware/toga/issues/4131), [#4132](https://github.com/beeware/toga/issues/4132), [#4141](https://github.com/beeware/toga/issues/4141), [#4142](https://github.com/beeware/toga/issues/4142), [#4144](https://github.com/beeware/toga/issues/4144), [#4145](https://github.com/beeware/toga/issues/4145), [#4146](https://github.com/beeware/toga/issues/4146), [#4147](https://github.com/beeware/toga/issues/4147), [#4148](https://github.com/beeware/toga/issues/4148), [#4149](https://github.com/beeware/toga/issues/4149), [#4150](https://github.com/beeware/toga/issues/4150), [#4151](https://github.com/beeware/toga/issues/4151), [#4152](https://github.com/beeware/toga/issues/4152), [#4153](https://github.com/beeware/toga/issues/4153), [#4154](https://github.com/beeware/toga/issues/4154), [#4155](https://github.com/beeware/toga/issues/4155), [#4157](https://github.com/beeware/toga/issues/4157), [#4160](https://github.com/beeware/toga/issues/4160), [#4160](https://github.com/beeware/toga/issues/4160), [#4160](https://github.com/beeware/toga/issues/4160), [#4162](https://github.com/beeware/toga/issues/4162), [#4166](https://github.com/beeware/toga/issues/4166), [#4168](https://github.com/beeware/toga/issues/4168), [#4169](https://github.com/beeware/toga/issues/4169), [#4170](https://github.com/beeware/toga/issues/4170), [#4171](https://github.com/beeware/toga/issues/4171), [#4172](https://github.com/beeware/toga/issues/4172), [#4173](https://github.com/beeware/toga/issues/4173), [#4174](https://github.com/beeware/toga/issues/4174), [#4175](https://github.com/beeware/toga/issues/4175), [#4177](https://github.com/beeware/toga/issues/4177), [#4178](https://github.com/beeware/toga/issues/4178), [#4179](https://github.com/beeware/toga/issues/4179), [#4180](https://github.com/beeware/toga/issues/4180), [#4181](https://github.com/beeware/toga/issues/4181), [#4182](https://github.com/beeware/toga/issues/4182), [#4183](https://github.com/beeware/toga/issues/4183), [#4184](https://github.com/beeware/toga/issues/4184), [#4185](https://github.com/beeware/toga/issues/4185), [#4186](https://github.com/beeware/toga/issues/4186), [#4192](https://github.com/beeware/toga/issues/4192), [#4193](https://github.com/beeware/toga/issues/4193), [#4194](https://github.com/beeware/toga/issues/4194), [#4195](https://github.com/beeware/toga/issues/4195), [#4196](https://github.com/beeware/toga/issues/4196), [#4197](https://github.com/beeware/toga/issues/4197), [#4198](https://github.com/beeware/toga/issues/4198), [#4207](https://github.com/beeware/toga/issues/4207), [#4209](https://github.com/beeware/toga/issues/4209), [#4210](https://github.com/beeware/toga/issues/4210), [#4212](https://github.com/beeware/toga/issues/4212), [#4213](https://github.com/beeware/toga/issues/4213), [#4214](https://github.com/beeware/toga/issues/4214), [#4215](https://github.com/beeware/toga/issues/4215), [#4217](https://github.com/beeware/toga/issues/4217), [#4217](https://github.com/beeware/toga/issues/4217), [#4224](https://github.com/beeware/toga/issues/4224), [#4225](https://github.com/beeware/toga/issues/4225), [#4234](https://github.com/beeware/toga/issues/4234), [#4240](https://github.com/beeware/toga/issues/4240), [#4241](https://github.com/beeware/toga/issues/4241), [#4242](https://github.com/beeware/toga/issues/4242), [#4243](https://github.com/beeware/toga/issues/4243), [#4244](https://github.com/beeware/toga/issues/4244), [#4245](https://github.com/beeware/toga/issues/4245), [#4246](https://github.com/beeware/toga/issues/4246), [#4247](https://github.com/beeware/toga/issues/4247), [#4248](https://github.com/beeware/toga/issues/4248), [#4249](https://github.com/beeware/toga/issues/4249), [#4250](https://github.com/beeware/toga/issues/4250), [#4251](https://github.com/beeware/toga/issues/4251), [#4252](https://github.com/beeware/toga/issues/4252), [#4253](https://github.com/beeware/toga/issues/4253), [#4254](https://github.com/beeware/toga/issues/4254), [#4255](https://github.com/beeware/toga/issues/4255), [#4257](https://github.com/beeware/toga/issues/4257), [#4266](https://github.com/beeware/toga/issues/4266), [#4267](https://github.com/beeware/toga/issues/4267), [#4268](https://github.com/beeware/toga/issues/4268), [#4269](https://github.com/beeware/toga/issues/4269), [#4272](https://github.com/beeware/toga/issues/4272), [#4274](https://github.com/beeware/toga/issues/4274), [#4280](https://github.com/beeware/toga/issues/4280), [#4281](https://github.com/beeware/toga/issues/4281), [#4282](https://github.com/beeware/toga/issues/4282), [#4283](https://github.com/beeware/toga/issues/4283), [#4284](https://github.com/beeware/toga/issues/4284), [#4285](https://github.com/beeware/toga/issues/4285), [#4286](https://github.com/beeware/toga/issues/4286), [#4287](https://github.com/beeware/toga/issues/4287), [#4288](https://github.com/beeware/toga/issues/4288), [#4289](https://github.com/beeware/toga/issues/4289), [#4290](https://github.com/beeware/toga/issues/4290), [#4291](https://github.com/beeware/toga/issues/4291), [#4292](https://github.com/beeware/toga/issues/4292), [#4293](https://github.com/beeware/toga/issues/4293), [#4294](https://github.com/beeware/toga/issues/4294), [#4295](https://github.com/beeware/toga/issues/4295), [#4308](https://github.com/beeware/toga/issues/4308), [#4309](https://github.com/beeware/toga/issues/4309), [#4310](https://github.com/beeware/toga/issues/4310), [#4311](https://github.com/beeware/toga/issues/4311), [#4312](https://github.com/beeware/toga/issues/4312), [#4313](https://github.com/beeware/toga/issues/4313), [#4316](https://github.com/beeware/toga/issues/4316), [#4321](https://github.com/beeware/toga/issues/4321), [#4322](https://github.com/beeware/toga/issues/4322), [#4323](https://github.com/beeware/toga/issues/4323), [#4324](https://github.com/beeware/toga/issues/4324), [#4325](https://github.com/beeware/toga/issues/4325), [#4326](https://github.com/beeware/toga/issues/4326), [#4328](https://github.com/beeware/toga/issues/4328), [#4330](https://github.com/beeware/toga/issues/4330), [#4333](https://github.com/beeware/toga/issues/4333), [#4336](https://github.com/beeware/toga/issues/4336), [#4337](https://github.com/beeware/toga/issues/4337), [#4341](https://github.com/beeware/toga/issues/4341), [#4345](https://github.com/beeware/toga/issues/4345), [#4350](https://github.com/beeware/toga/issues/4350), [#4351](https://github.com/beeware/toga/issues/4351), [#4352](https://github.com/beeware/toga/issues/4352), [#4355](https://github.com/beeware/toga/issues/4355), [#4361](https://github.com/beeware/toga/issues/4361), [#4367](https://github.com/beeware/toga/issues/4367), [#4370](https://github.com/beeware/toga/issues/4370)
