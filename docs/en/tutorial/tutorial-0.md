...
If you haven't got Python 3 installed, you can do so via [the official installer](https://www.python.org/downloads), or using your operating system's package manager.
...
We strongly suggest that you **don't** do this. We'd suggest creating a [virtual environment](https://docs.python-guide.org/dev/virtualenvs/) first, and installing toga in that virtual environment as directed at the top of this guide.
