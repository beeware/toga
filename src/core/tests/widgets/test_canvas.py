...
class TestContext2D(unittest.TestCase):
    def setUp(self):
        self.factory = MagicMock()
        self.factory.Context2D = MagicMock(return_value=MagicMock(spec=toga_dummy.widgets.canvas.Context2D))
...
class TestMatrix(unittest.TestCase):
    def setUp(self):
        self.factory = MagicMock()
        self.factory.Matrix = MagicMock(return_value=MagicMock(spec=toga_dummy.widgets.canvas.Matrix))
