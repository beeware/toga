...
class DividerApp(toga.App):
    def startup(self):
        ...
        style = {"margin_top": 24}
        substyle = {"margin_right": 12, "margin_left": 12, "flex": 1}
        ...
        self.main_window.content = toga.Box(
            children=[
                ...
                toga.Divider(**style),
                toga.Label("Section 2", **style),
                toga.Divider(**style),
                toga.Label("Section 3", **style),
                toga.Box(
                    children=[
                        toga.TextInput(placeholder="First textbox"),
                        toga.Divider(direction=toga.Divider.VERTICAL, **substyle),
