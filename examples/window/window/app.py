...
class WindowDemoApp(toga.App):
    ...
    def startup(self):
        ...
        self.label = toga.Label("Ready.", style=Pack(font_size=15))

        # Buttons
        btn_style = Pack(flex=1, padding=5, font_size=15)
        ...
        self.main_box = toga.Box(
            ...
            style=Pack(direction=COLUMN, font_size=15),
        )
        ...
        self.next_box = toga.Box(
            children=[btn_change_back], style=Pack(direction=COLUMN, font_size=15)
        )
