...
"""
Some styling features called "Liquid Glass" on iOS are only
...
compiled with iOS 26+ and does not contain ``UIDesignRequiresCompatibility``.
iOS 18- will continue to disable adaptations that Toga makes
