...
from ..constants import ToggleRole
from .base import StyleT, Widget


class OnChangeHandler(Protocol):
    def __call__(self, widget: Toggle, **kwargs: Any) -> None:
...
class Toggle(Widget):
    def __init__(
        ...
        role: ToggleRole = ToggleRole.AUTOMATIC,
        ...
        **kwargs,
        ...
        :param role: The type of Toggle to use.
    ...
    def _create(self) -> Any:
        try:
            return self.factory.Toggle(interface=self)
    ...
    @on_change.setter
    def on_change(self, handler: toga.widgets.toggle.OnChangeHandler) -> None:
