...
class alignment_property(validated_property):
    def __init__(self):
        super().__init__(TOP, RIGHT, BOTTOM, LEFT, CENTER)
    ...
    def __set_name__(self, owner, name):
        ...
        # class.
        owner.align_items = align_items_property()
    ...
    def is_set_on(self, obj):
        ...
        return super().is_set_on(obj) or hasattr(obj, "_align_items")
...
class align_items_property(validated_property):
    def __init__(self):
        super().__init__(START, CENTER, END)
    ...
    def is_set_on(self, obj):
        return super().is_set_on(obj) or hasattr(obj, "_alignment")
