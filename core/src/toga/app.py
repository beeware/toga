...
class App:
    ...
    def _startup(self) -> None:
        ...
        print("app._startup() - standard commands created (app)")  ## Winui3 debug ##
        ...
        self.startup()
        print("app._startup() - app.startup() finished")  ## Winui3 debug ##
        ...
        print("app._startup() - initial windows created")  ## Winui3 debug ##
        ...
        print("app._startup() - menus created")  ## Winui3 debug ##
        ...
        print("app._startup() - status icons created")  ## Winui3 debug ##
        ...
        print("app._startup() - toolbars created")  ## Winui3 debug ##
