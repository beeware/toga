...
def test_deprecated_info_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"info_dialog\(...\) has been deprecated; "
...
def test_deprecated_question_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"question_dialog\(...\) has been deprecated; "
...
def test_deprecated_confirm_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"confirm_dialog\(...\) has been deprecated; "
...
def test_deprecated_error_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"error_dialog\(...\) has been deprecated; "
...
def test_deprecated_stack_trace_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"stack_trace_dialog\(...\) has been deprecated; "
...
def test_deprecated_save_file_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"save_file_dialog\(...\) has been deprecated; "
...
def test_deprecated_open_file_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"open_file_dialog\(...\) has been deprecated; "
...
def test_deprecated_select_folder_dialog(window, app):
    ...
    with pytest.warns(
        ...
        DeprecationWarning,
        match=r"select_folder_dialog\(...\) has been deprecated; "
...
def test_deprecated_names_select_folder_dialog(window, app):
    ...
    with pytest.warns(
        DeprecationWarning,
        match=r"select_folder_dialog\(multiselect\) "
        r"has been renamed multiple_select",
    ), pytest.warns(
        DeprecationWarning,
        match=r"Synchronous `on_result` handlers have been deprecated; "
        r"use `await` on the asynchronous result",
