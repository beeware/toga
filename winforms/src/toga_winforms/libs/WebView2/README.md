...
These DLLs are the official stable release v1.0.2592.51 (net462), downloaded from [NuGet](https://www.nuget.org/packages/Microsoft.Web.WebView2). They are released under the terms of the [license in this root of this project](../../../../LICENSE.WebView2.md).
